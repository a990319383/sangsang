...
public class SqlParseCache extends DefaultBeanPostProcessor {
     ...
     **/
    public static void init(SangSangProperties sangSangProperties) {
        if (sangSangProperties.getLruCapacity() != null && !sangSangProperties.getLruCapacity().equals(NumberConstant.FIVE_HUNDRED)) {
            SQL_PARSE_CACHE = CacheUtil.newLRUCache(sangSangProperties.getLruCapacity());
        }
    }
