...
public class IsolationInstanceCache extends DefaultBeanPostProcessor {
    ...
    public void init(SangSangProperties sangSangProperties,
        ...
        //1.配置校验
        if (CollectionUtils.isEmpty(sangSangProperties.getScanEntityPackage())) {
            throw new IsolationException("未配置扫描路径，请检查配置 sangsang.scanEntityPackage");
        }
        ...
        log.debug("【sangsang】<isolation>初始化完毕，耗时:{}ms", (System.currentTimeMillis() - startTime));
    }
