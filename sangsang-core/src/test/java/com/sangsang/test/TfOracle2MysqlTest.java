...
public class TfOracle2MysqlTest {
    ...
    public void oracle2mysqlTransformation() throws Exception {
        ...
        //设置模式是oracle转mysql
        TransformationProperties transformation = sangSangProperties.getTransformation();
...
//        sangSangProperties.setIdentifierQuote(Arrays.asList(SymbolConstant.FLOAT, SymbolConstant.SINGLE_QUOTES));
        sangSangProperties.setIdentifierQuote(Arrays.asList(SymbolConstant.FLOAT, SymbolConstant.DOUBLE_QUOTES));
        //初始化缓存
