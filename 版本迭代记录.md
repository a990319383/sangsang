...
- 【<font color='skyblue'>**调整**</font>】数据库标识符引用符配置项调整
  ...
  ```
  #支持配置数组
  field.identifierQuote[0]='
  field.identifierQuote[1]=`
  ```
...
- 【<font color='skyblue'>**调整**</font>】调整mysql2dm语法转换时强制所有字段转换为小写的配置项
  - 旧配置方式：field.transformation.forcedLowercase=true
  - 新配置方式：field.transformation.mysql2dm.forcedLowercase=true
- 【<font color='orange'>**新增**</font>】新增oracle转mysql的语法转换支持
  - 目前仅提供了分页语法的转换，其它差异化语法开发中
