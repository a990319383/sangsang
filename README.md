...
- 邮箱：990319383@qq.com
- QQ交流群：1072901252    
- 意见和BUG欢迎群里面讨论，对您有帮助的话，点个star是对我最大的肯定
  - 群文件有 mysql sm4 国密算法扩展包
  - 版本迭代修复的问题群公告会第一时间通知
  - 感恩每一颗小星星

> 此文档针对3.6.0以后的版本，各版本记录详见文档《版本迭代记录.md》
>
> 请使用最新版本，没有特殊情况，bug都会在最新版本修改。
>
> - 已发布最新版本git分支为master
> - 目前迭代中最新git分支为3.6.0
> - 中央仓库最新版本为3.6.1-alpha
